...
public class Product_Sale_Adapter extends RecyclerView.Adapter<Product_Sale_Adapter.PlaceViewHolder> {
    ...
    public Product_Sale_Adapter(List<ModelProduct> modelProducts, Context context) {
    ...
    public PlaceViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        ...
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_product_sale,viewGroup,false);
