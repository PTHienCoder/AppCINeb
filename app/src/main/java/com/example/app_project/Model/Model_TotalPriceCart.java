...
public class Model_TotalPriceCart {
    ...
    public List<com.example.app_project.Model.Model_TotalPriceCart> getModel_TotalPriceCart() {
        return Model_TotalPriceCart;
    }

    public void setModel_TotalPriceCart(List<com.example.app_project.Model.Model_TotalPriceCart> model_TotalPriceCart) {
