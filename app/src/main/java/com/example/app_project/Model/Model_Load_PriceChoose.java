...
public class Model_Load_PriceChoose {
    ...
    public List<com.example.app_project.Model.Model_Load_PriceChoose> getModel_Load_PriceChoose() {
        return Model_Load_PriceChoose;
    }

    public void setModel_Load_PriceChoose(List<com.example.app_project.Model.Model_Load_PriceChoose> model_Load_PriceChoose) {
